	...
	async execute(message, args) {
        ...
        if(userCardData[DBM_Card_User_Data.columns.daily_last]==dateToken){
            ...
            var objEmbed = {
                ...
                description : `:x: Sorry, you have already received your daily points today. Please wait for **${timeRemaining}** until you can do it again.`
            };
        ...
        if(optionalColor!=null){
            ...
            objEmbed.description = `<@${userId}> has received ** ${colorPoint} ${optionalColor} color point ** from the daily command.`;
        } else {
            query = `UPDATE ${DBM_Card_User_Data.TABLENAME} 
            ...
            objEmbed.description = `<@${userId}> has received ** ${colorPoint} overall color point ** from the daily command.`;
        }
