class Properties {
    static icon = "https://waa.ai/JEw8.png";
    static color = "red";
    static fullname = "Akira Kenjou";
    static alter_ego = "Cure Chocolat";
    static hint_chiguhaguu = "With Strength and Love! Let's La Mix It All Up! <x>! Is Ready To Serve!";
    static total = 0;
...
class Avatar {
    static normal = {
        ...
        transform_quotes2:"With Strength and Love! Let's La Mix It All Up! Cure Chocolat! Is Ready To Serve!",
