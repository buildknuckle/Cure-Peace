...
class Properties {
    static icon = "https://waa.ai/JEwM.png";
    static color = "green";
    static fullname = "Ciel Kirahoshi";
    static alter_ego = "Cure Parfait";
    static hint_chiguhaguu = "With Dreams and Hope! Let's La Mix It All Up! <x>! Is Ready To Serve";
    static total = 0;
