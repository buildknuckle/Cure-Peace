class Properties {
    static icon = "https://waa.ai/JEwE.png";
    static color = "blue";
    static fullname = "Erika Kurumi";
    static alter_ego = "Cure Marine";
    static hint_chiguhaguu = "The flower that flutters in the ocean winds, <x>!";
    static total = 0;
