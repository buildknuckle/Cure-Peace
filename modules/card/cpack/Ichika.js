...
class Properties {
    static icon = "https://waa.ai/JEVP.png";
    static color = "pink";
    static fullname = "Ichika Usami";
    static alter_ego = "Cure Whip";
    static hint_chiguhaguu = "With Liveliness and Smiles! Let's La Mix It All Up! <x>! Ready To Serve!";
    static total = 0;
