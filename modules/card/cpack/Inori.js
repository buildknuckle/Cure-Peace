class Properties {
    static icon = "https://waa.ai/JEwJ.png";
    static color = "yellow";
    static fullname = "Inori Yamabuki";
    static alter_ego = "Cure Pine";
    static hint_chiguhaguu = "The yellow heart is the emblem of faith! Freshly-harvested, <x>!";
    static total = 0;
    static series = "fresh";
}
