...
class Properties {
    static icon = "https://waa.ai/JEVW.png";
    static color = "pink";
    static fullname = "Love Momozono";
    static alter_ego = "Cure Peach";
    static hint_chiguhaguu = "The pink heart is the emblem of love. Freshly-picked, <x>!";
    static total = 0;
    static series = "fresh";
}
