class Properties {
    static icon = "https://waa.ai/JEVg.png";
    static color = "pink";
    static fullname = "Megumi Aino";
    static alter_ego = "Cure Lovely";
    static hint_chiguhaguu = "The big love spreading throughout the world! <x>!";
    static total = 0;
