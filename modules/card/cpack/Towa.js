class Properties {
    static icon = "https://waa.ai/JEwI.png";
    static color = "red";
    static fullname = "Towa Akagi";
    static alter_ego = "Cure Scarlet";
    static hint_chiguhaguu = "Princess of crimson flames! <x>!";
    static total = 0;
...
class Avatar {
    static normal = {
        ...
        transform_quotes2:"Princess of crimson flames! Cure Scarlet!",
