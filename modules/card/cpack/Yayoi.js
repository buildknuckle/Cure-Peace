class Properties {
    ...
    static color = "yellow";
    static fullname = "Yayoi Kise";
    static alter_ego = "Cure Peace";
    static hint_chiguhaguu = "Sparkling, glittering, rock-paper-scissors! <x>!";
    static total = 0;
    static series = "smile";
}
...
class Avatar {
    static normal = {
        ...
        transform_quotes2:"Sparkling, glittering, rock-paper-scissors! Cure Peace!",
